function ProcessPolImages(rootFolder, crossMultiple)
...
variablesToClear = {'crossStack', 'dirImage', 'HH_norm', 'sample_std',...
    'dirImage','rSquared', 'lin_reta','biref','WL_thresh', 'aligned',...
    'period'};
...
for k = 1 : numROIs
    ...
    if(~isfile(saveFolder + "/" + roiFolders(k)+"_stitch_save.mat"))
        ...
        disp("      Saving");
        save(saveFolder + roiFolders(k)+"_stitch_save.mat", variablesToSave{:}, '-mat')
